...
def get_scores(dev_or_final: str):
    ...
    solutions_dir = os.path.join(base_solutions_dir, "clavaddpm_white_box", dev_or_final)
    assert os.path.exists(solutions_dir), f"Directory {solutions_dir} does not exist. Please contact competition oragnizers."

    predictions_dir = os.path.join(base_predictions_dir, "clavaddpm_white_box", dev_or_final)
    assert os.path.exists(predictions_dir), f"Directory {predictions_dir} does not exist. \
        Ensure root of extracted submission contains clavaddpm_white_box/{dev_or_final} folder. \
        Ex: clavaddpm_white_box/{dev_or_final}/clavaddpm_#/predictions.csv"
